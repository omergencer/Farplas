#! /usr/bin/env python3
import pymysql, pickle,joblib, os
import  pandas as pd
...
try:
    rf2 = joblib.load(glob('/home/pi-e114/Injection-machine-parameter-optimization/model/model_*')[0])
    scaler = joblib.load(glob("/home/pi-e114/Injection-machine-parameter-optimization/scaler/scaler_*")[0])
